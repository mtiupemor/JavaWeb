            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 scrollpoint sp-effect1">
                        <h4>Resumiendo los pasos para la realización del árbol de eventos:</h4>
                    ...
                    <div class="col-md-8 col-sm-8" >
                        <img src="../img/freeze/diagrama_aevento.png" class="ejemplosFallas" alt="">
                        <div class="info-diagrama">
                            ...
                            <p>
                                ...
                                Cada sistema está compuesto por dos bifurcaciones los cuales representan el éxito (parte superior) y falla del sistema (parte inferior).
                            </p>
                            <p>
                                Se puede observar las diferentes se secuencias de accidentes posibles (SA1 y SA2). Para obtener la frecuencia de cada secuencia de accidente, de una manera simplificada, se tiene que multiplicar la frecuencia del evento iniciador, por la probabilidad de falla de cada uno de los sistemas involucrados en la secuencia de accidente. Sin embargo, la manera de cuantificar las secuencias es resolver todas las combinaciones de los conjuntos mínimos de corte.
